...
public class TermuxFileUtils {
     ...
     * be under `/data/user/[id]/[package_name]` instead of `/data/user/150/[package_name]`
     ...
     * and will not be automatically created, unless there is a bind mount from `/data/user/150` to
     * `/data/user/[id]`, ideally in the right namespace.
     * https://source.android.com/devices/tech/admin/multi-user
     *
     *
     * On Android version `<=10`, the `/data/user/150` is a symlink to `/data/user/150` directory.
     * https://cs.android.com/android/platform/superproject/+/android-10.0.0_r47:system/core/rootdir/init.rc;l=589
     * {@code
     * symlink /data/user/150 /data/user/150
     * }
     *
     * {@code
     * /system/bin/ls -lhd /data/user/150 /data/user/150
     * drwxrwx--x 179 system system 8.0K 2021-xx-xx xx:xx /data/user/150
     * lrwxrwxrwx   1 root   root     10 2021-xx-xx xx:xx /data/user/150 -> /data/user/150
     * }
     *
     * On Android version `>=11`, the `/data/user/150` directory is bind mounted at `/data/user/150`.
     ...
     * {@code
     * # Unlink /data/user/150 if we previously symlink it to /data/user/150
     * rm /data/user/150
     *
     * # Bind mount /data/user/150 to /data/user/150
     * mkdir /data/user/150 0700 system system encryption=None
     * mount none /data/user/150 /data/user/150 bind rec
     * }
     *
     * {@code
     * /system/bin/grep -E '( /data )|( /data/user/150 )|( /data/user/[0-9]+ )' /proc/self/mountinfo 2>&1 | /system/bin/grep -v '/data_mirror' 2>&1
    ...
    public static String getTermuxFilesStatMarkdownString(@NonNull final Context context) {
        ...
        statScript
            ...
            .append("/system/bin/grep -E '( /data )|( /data/user/150 )|( /data/user/[0-9]+ )' /proc/self/mountinfo 2>&1 | /system/bin/grep -v '/data_mirror' 2>&1");
